...
class SessionVarianceAugmentationConfig(BaseModel):
    type: Literal["session_variance"]
...
AugmentationConfig = SessionVarianceAugmentationConfig  # Union of all augmentation configs