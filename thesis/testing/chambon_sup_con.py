...
if __name__ == "__main__":
    ...
    raw_datasets = {
        ...
        'lee2019': (braindecode_dataset_base_path / 'lee2019_512_ica_highpass_filtered_resampled_120', DatasetSplitConfig(train_prop=0.7, extrap_val_prop=0.2, extrap_test_prop=0, intra_val_prop=0.1, intra_test_prop=0)),  # only has one session so invalid for evaluation
        'kaya': (kaya_dataset_path, DatasetSplitConfig(train_prop=0.75, extrap_val_prop=0.2, extrap_test_prop=0, intra_val_prop=0.05, intra_test_prop=0))
    }
